...
class profileviewer extends StatefulWidget {
  ...
  String? uid;
  String? role;
  profileviewer({Key? key,this.uid,this.role}) : super(key: key);
  @override
  _profileviewerState createState() => _profileviewerState(uid: this.uid,role: role);
}
...
class _profileviewerState extends State<profileviewer> {
  ...
  _profileviewerState({this.uid,this.role});
  ...
  void initState() {
    ...
    stream = FirebaseFirestore.instance
        .collection(role=="student"?"studentdata":"facultydata")
        .doc(uid)
        .snapshots();
                          ...
                          child: Form(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                coverletterfield(coverletter=="null"?"":coverletter!)
                              ],
                            ),
                          ),
                        ),
                                                              ...
                                                              InputChip(
                                                                ...
                                                                onDeleted: () =>
                                                                    setstate(() =>
                                                                    {
                                                                      ...
                                                                      FirebaseFirestore.instance.collection("facultydata").doc(FirebaseAuth.instance.currentUser!.uid).update({
                                                                        "skills": skills
                                                                      })
                                                                    }),
                                                                deleteIconColor:
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Responsive.isdesktop(context)
                                        ...
                                        child: Wrap(children: [
                                          Container(
                                            ...
                                            decoration: BoxDecoration(border:Border(right:BorderSide(width: 0.7, color:finalgrey),)),
                                          ),
                                        ]))
                                        : Container(),
                                    ...
                                    Expanded(
                                      ...
                                      child: Container(
                                        decoration: BoxDecoration(border:Border(left:BorderSide(width: 0.7, color:finalgrey),)),
                                                  ...
                                                  Expanded(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            Text(
                                                              doc["cover"]=="null"?"No Cover letter has been added yet":doc["cover"],
                                                              style: getsimplestyle(
                                                                  13,
                                                                  FontWeight
                                                                      .w300,
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  works.isNotEmpty
                                                    ...
                                                    padding:
                                                    EdgeInsets.only(
                                                        left:30,right:30,top: works.isNotEmpty?30:10,bottom: 30),
                                                  ),
                                                ],
                                              ),
                                            ),
